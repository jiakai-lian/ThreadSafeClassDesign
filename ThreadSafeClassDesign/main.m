...
//                sleep(SLEEP_INTERVAL);
            ...
            else
            {
                ...
                item.itemId = nil;
//                sleep(SLEEP_INTERVAL);
                item.itemId = [NSString stringWithFormat:@"%zu",i];
            }
        });
...
int main(int argc, const char * argv[]) {
    testScenario([Item itemWithItemId:@"1" itemName:@"item1" itemDescription:@"item1"]);
    testScenario([ItemAtomic itemWithItemId:@"1" itemName:@"item1" itemDescription:@"item1"]);
    ...
    testScenario([ItemSyncQueue itemWithItemId:@"1"
                                      itemName:@"item1"
                               itemDescription:@"item1"]);
    testScenario([ItemAsyncSetter itemWithItemId:@"1" itemName:@"item1" itemDescription:@"item1"]);
    testScenario([ItemBarrierAsyncSetter itemWithItemId:@"1" itemName:@"item1" itemDescription:@"item1"]);
